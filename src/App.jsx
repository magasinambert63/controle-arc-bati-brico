...
export default function App(){
 ...
 return <div className="app">
  <header><div><h1>BATI BRICO</h1><p>Contrôle ARC fournisseur V3 — moteur article intelligent</p></div><div className="status"><span>Contrôle</span><b>{results.length?`${ok} OK / ${ec+man+sup} alerte(s)`:'En attente'}</b></div></header>
